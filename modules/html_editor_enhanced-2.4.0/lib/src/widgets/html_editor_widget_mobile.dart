...
class _HtmlEditorWidgetMobileState extends State<HtmlEditorWidget> {
            ...
            children: [
              widget.htmlToolbarOptions.toolbarPosition ==
                  ...
                  ? ToolbarWidget(
                      ...
                      funLoading: _showLoading, funError: _showError)
              ...
              widget.htmlToolbarOptions.toolbarPosition ==
                  ...
                  ? ToolbarWidget(
                      ...
                      controller: widget.controller,
                      htmlToolbarOptions: widget.htmlToolbarOptions,
                      callbacks: widget.callbacks, funLoading: _showLoading, funError: _showError)
                  : Container(height: 0, width: 0),
            ],
          ),
        ),
  ...
  dynamic _showLoading() => showDialog(context: context, builder: (BuildContext context) {
    return PointerInterceptor(child: StatefulBuilder(builder:
  ...
  dynamic _showError({String? error}) {
    ...
    final snackBar = SnackBar(shape: const RoundedRectangleBorder(),
        ...
        content: Text(error??'Chèn ảnh/video thất bại. Vui lòng thử lại!', style: TextStyle(color: Colors.white, fontSize: 18)));
