...
class ReferrerHistoryReceiveGivePage extends BasePage {
  ReferrerHistoryReceiveGivePage({Key? key})
      : super(pageState: _ReferrerHistoryReceiveGivePageState(), key: key);
}

class _ReferrerHistoryReceiveGivePageState extends BasePageState {
  ...
  void _loadMore() {
    if (_lock) return;
    _lock = true;
    bloc!.add(LoadReferrerHistoryListEvent("give_point_referral"));
  }
        ...
        children: [
          Align(alignment: Alignment.centerRight,child: Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.end,children: [
              ...
              Text( "$totalPoint",style: const TextStyle(color: Colors.red))])),
          ),
          Expanded(
            child: SingleChildScrollView(scrollDirection: Axis.horizontal,child: SizedBox(width: 2.sw,
              child: Column(children: [
                  FarmManageTitle(
                    const [
                      ...
                      ['Điểm trả thưởng', 7, TextAlign.center]
                    ],
                    width: 2.sw,
                    size: 13,
                    padding: 20.sp,
